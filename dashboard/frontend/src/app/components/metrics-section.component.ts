...
@Component({
  ...
  template: `
    <section class="grid gap-5 xl:grid-cols-2">
      <article class="space-y-4 rounded-[2rem] border border-white/70 bg-white/75 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur dark:border-slate-800/80 dark:bg-slate-900/75">
